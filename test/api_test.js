...
const { quotes, searchQuotes } = require('../public/assets/quotes');
  ...
  it("Fetch Less Quotes Than Allowed Headers", (done) => {
    chai
      ...
      .end((err, res) => {
        ...
        res.header.should.have.property("access-control-allow-origin").to.be.deep.equal("*");;
        res.header.should.have.property("content-type").to.be.deep.equal('text/html; charset=utf-8');
        res.body.should.be.an("object");
        done();
      });
  });
  ...
  it("Fetch With Empty Search Query Headers Payload", (done) => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.be.an("object");
        res.body.should.have.property("status").to.deep.equal(400);
        res.body.should.have.property("error").to.deep.equal("Invalid search query!");
        done();
      });
  });
